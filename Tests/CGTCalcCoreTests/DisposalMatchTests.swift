...
class DisposalMatchTests: XCTestCase {
  ...
  func testMatchingDisposal() throws {
    ...
    let disposalMatch = DisposalMatch(kind: .SameDay(SubTransaction(transaction: acquisition)), disposal: SubTransaction(transaction: disposal))
  ...
  func testSection104Disposal() throws {
    ...
    let disposalMatch = DisposalMatch(kind: .Section104(Decimal(string: "100")!, Decimal(string: "2.5")!), disposal: SubTransaction(transaction: disposal))
